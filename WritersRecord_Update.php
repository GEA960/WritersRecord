  ...
  <body class="size-1280">
      ...
      <nav class="background-transparent background-primary-dott full-width sticky">          
        <div class="top-nav"> 
          ...
          <div class="logo hide-l hide-xl hide-xxl">
             <a href="WritersRecord_Update.php" class="logo">
              <!-- Logo White Version -->
    ...
    <main role="main">
      <article>    
        ...
        <b>
        <!-- Section 1 -->
       <form action="WritersRecord_Update.php" method="Post">
...
mysql_select_db('db_writers') or die ("Error");
...
$results = mysql_query("SELECT * FROM tb_writersrecord WHERE WritersID = $WritersID") or die("Error");
$num_rows = mysql_num_rows($results);

if ($num_rows == 1) {
    
    mysql_query("UPDATE tb_writersrecord SET WritersID='$WritersID',Name='$Name',Age='$Age',Address='$Address',Skills='$Skills',Specialization='$Specialization',AcademicDegree='$AcademicDegree',PercentagePerformance='$PercentagePerformance', DateEmployed='$DateEmployed', Feedback='$Feedback' WHERE WritersID = $WritersID")
      or die ("Data Not Updated");
    
                     } 

  else{
     die("WriterID does not exist, Data Not Updated");
   } 
