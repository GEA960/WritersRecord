      ...
      <nav class="background-transparent background-primary-dott full-width sticky">          
        <div class="top-nav"> 
          ...
          <div class="logo hide-l hide-xl hide-xxl">
             <a href="WritersRecord_Search.php" class="logo">
              <!-- Logo White Version -->
    ...
    <main role="main">
      <article>    
        ...
        <header class="section background-image text-center" style="background-image:url(img/img-05.jpg)">
          ...
          <p class="animated-element text-white">Search any writer's Record you want to view.</p>
        ...
        session_destroy();
        ?>
        <form action=WritersRecord_Search.php method=POST>
        <br>
        <font> Writers ID: &nbsp;&nbsp;&nbsp;&nbsp; 
        <input type=text name=WritersID size=20>
        <br><br>
        ...
        //retrieve
         $result=mysql_query("SELECT* FROM tb_writersrecord WHERE WritersID='$WritersID'") or die(mysql_error());
